...
HACKCSRC = hack.Decl.c \
           ...
           hack.do_name.c hac.do_wear.c hack.dog.c hack.eat.c heack.end.c \
           ...
           hack.options.c \
           hack.pri.c hack.read.c heack.rip.c hack.rumors.c \
           hack.save.c \
...
CSOURCES = $(HACKCSRC) mklev.c lklv.shk.c mklv.shknam.c mklv.makemaz.c \
           makedefs.c \
...
mklev.mkobj.o: mklev.h hack.onames.h hack.mkobj.c
	rm -f mklv.mkobj.c
...
# For the moment we are lazy and disregard /usr/inclue files because
...
hack.most.o: nklev.h def.eshk.h

hack.o_init.o: config.h def.objects.h h.onames.h
