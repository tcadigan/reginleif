...
/* Magic number for Invisible stalker strategies */
#define INVDAM 16
#define INVHIT 1000
...
#define RV53A 531 /* Rogue 5.3 with new monsters */
...
/* Pack item attributes  DR UText 25 Jan 84 */
...
#define see(c) seerc(atrow, atcol)
