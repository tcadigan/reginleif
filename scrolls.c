            ...
            if(py.flags.blind > 0) {
                ...
                if(get_item(&item_val, "Read which scroll?", &redraw, j, k)) {
                    ...
                    while(i != 0) {
                        ...
                        if(first) {
                            if((j != 4) && (j != 25)) {
                                msg_print("As you read the scroll if vanishes.");
                                first = FALSE;
                            }
                        }
                        ...
                        case 4:
                            ...
                            /* MAke sure the player sees the message before ident_spell */
                            msg_print(" ");
                        ...
                        case 5:
                            if(remove_curse()) {
                                msg_print("You feel as if someone is watching over your.");
                                ident = TRUE;
                            }
                        ...
                        case 25:
                            ...
                            /* Make sure player sees message before recharge */
                            msg_print(" ");
                        ...
                        case 33:
                            ...
                            if(i_ptr->tval != 0) {
                                ...
                                objdes(tmp_str, INVEN_WIELD, FALSE);
                                sprintf(out_val, "Your %s glows black, fades", tmp_str);
                                msg_print(out_val);
