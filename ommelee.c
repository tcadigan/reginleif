...
/*
 * Decide monster actions in tactical combat mode. If moster is skilled, it can
 * try see the player's attacks coming and try to block appropriately
 */
