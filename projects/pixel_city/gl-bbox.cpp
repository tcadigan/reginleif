...
void gl_bbox::set_min(gl_vector3 const &min) { min_ = min; }

void gl_bbox::set_max(gl_vector3 const &max) { max_ = max; }

gl_vector3 gl_bbox::get_min() const { return min_; }

gl_vector3 gl_bbox::get_max() const { return max_; }
