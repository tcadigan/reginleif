...
void gl_vector2::set_x(float x) { data_.at(0) = x; }

void gl_vector2::set_y(float y) { data_.at(1) = y; }

std::array<float, 2> gl_vector2::get_data() { return data_; }

float gl_vector2::get_x() const { return data_.at(0); }

float gl_vector2::get_y() const { return data_.at(1); }
