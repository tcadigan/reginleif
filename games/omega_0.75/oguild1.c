 ...
 * l_* functions
 *
 * These functions implement the various guilds. They are all
 * l_* functions since they are basically activated at some site or
 * other.
 */
#include "oguild1.h"
    ...
    if(nighttime()) {
        ...
        case 0:
            ...
            if(ynq2() == 'y') {
                ...
                if(Player.rank[ARENA] > 0) {
                    ...
                    print1("\'A paladin in the ranks? You must be joking.\'");
                }
                    ...
                    morewait();
                    print1("The Legion pays you a 500Au induction fee.");
                    morewait();
                    ...
                    /* Shortsword */
                    *newitem = Objects[WEAPONID + 1];
                    gain_item(newitem);
                    newitem = (pob)malloc(sizeof(objtype));

                    /* Leather */
                    *newitem = Objects[ARMORID + 1];
                    gain_item(newitem);
                    Player.cash += 500;
        ...
        case COLONEL:
            if((Player.level > Commandantlevel) && find_and_remove_item(CORPSEID + 0, ML10 + 4)) {
                ...
                morewait();
                clearmsg();
                print1("The Legion is assembled to salute you!");
                ...
                clearmsg();
                print1("You CO expresses satisfaction with your progress.");
...
void l_castle()
{
    ...
    if(Player.level < 3) {
        ...
        if(Player.rank[NOBILITY] == 0) {
            ...
            if(ynq1() == 'y') {
                print2("Splendid. Bring be the head of the Goblin King.");
            ...
            if(find_and_remove_item(CORPSEID, ML3 + 5)) {
                ...
                morewait();
                print1("Bring me a Holy Defender!");
                print2("One is said to be in the possessions of the Great Wyrm");
                morewait();
                clearmsg();
                print1("in the depths of the sewers below the city.");
            }
            else {
                print2("Do not return until you acheive the quest, caitiff!");
            }
        }
            ...
            if(find_and_remove_item(ARMORID + 12, -1)) {
                ...
                morewait();
                print1("By the way, you might find the Orb in the possessions");
...
void l_arena()
{
    ...
    if(response == 'r') {
        if(Player.rank[ARENA] > 0) {
            ...
            print2("Yer too weak to be a gladiator!");
        }
        else {
            ...
            /* Club */
            *newitem = Objects[WEAPONID + 17];
            gain_item(newitem);
            newitem = (pob)malloc(sizeof(objtype));

            /* Shield */
            *newitem = Objects[SHIELDID + 2];
            gain_item(newitem);
            ...
            if((Player.rank[ARENA] < 4)
               ...
               && ((Arena_Opponent % 3) == 0)) {
                if(Player.rank[ARENA] > 0) {
                    ++Player.rank[ARENA];
                    morewait();
                    print1("You've been promoted to a stonger class!");
