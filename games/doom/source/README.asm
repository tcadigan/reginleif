...
as separate modules including Makefile support, be my gues.

Modules tmap.s includes the inner loops for texture mapping,
...
// ebp frac
        ...
        shrl scx,25 // finish calculation for first pixel
        movl edx,ebp // begin calculating second pixel
        addl ebp,ebx // advance frac pointer
        shrl edx,25 // finish cacluation for second pixel
...
patch2:
        ...
        addl edi,SCREENWIDTH * 2 // advance third pixel destination
...
checklast:
        testl [pixelcount],1
        jz done
        moveb [edi],al // write final pixel
...
// build composite step
        ...
        movl eas,OFFSET hpatch1 + 2 // convince tasm to modify code...
        movl[eax],ebx
...
// edp frac
        ...
        shldl edx,ebp,22 // begin calucating fouruth pixel (y units)
