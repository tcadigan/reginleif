/*
 * Omega (c) 1987-1989 by Laurance Raphael Brothers
 *
 * ofile.c
 *
 ...
 * Returns:
 *     1 if OK
 *     0 if impossible to run
 *    -1 if possible but not OK
 */
int filecheck()
{
    int impossible = FALSE;
    int badbutpossible = FALSE;
    int result;
...
/* Dispaly a file given a string name of file */
