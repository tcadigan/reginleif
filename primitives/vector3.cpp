...
GLvector GLvector::operator+(GLvector const &c)
{
    return glVector(x + c.x, y + c.y, z + c.z);
}

GLvector GLvector::operator+(float const &c)
{
    return glVector(x + c, y + c, z + c);
}

void GLvector::operator+=(GLvector const &c)
{
    x += c.x;
    y += c.y;
    z += c.z;
...
void GLvector::operator+=(float const &c)
{
    x += c;
    y += c;
    z += c;
...
bool GLvector::operator==(GLvector const &c)
{
