 ...
 * This version of Rog-O-Matic runs with Rogue 5.3.
 */
 ...
 * Printed when no score file is avialable in dumpscore()
 */

#define BEST 11316

/*
 * Rog-O-Matic will not tyr to bead scores higher than BOGUS which
 ...
 * This variables must be defined, but will not be used unless RGMDIR
 * is also defined
 */
...
/*
 * This variable defines the "local" copy or Rogue, which may have only
