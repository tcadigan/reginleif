...
void monster_strike(struct monster *m)
{
    if(player_on_sanctuary()) {
        print1("The aegis of your diety protects you!");
    }
    else {
...
void monster_action(struct monster *m, int action)
{
    ...
    if((action >= M_MELEE_NORMAL) && (action < M_MOVE_NORMAL)) {
        /* Kludge allows multiple attack forms */
...
char *mantype()
{
    ...
    case 1:
        ...
        break;
    case 2:
        strcpy(Str3, "barbarian");

        break;
    case 3:
        strcpy(Str3, "hairdresser");

        break;
    case 4:
        strcpy(Str3, "accountant");
    ...
    case 16:
        ...
        break;
    case 17:
        strcpy(Str3, "dilettante");

        break;
    case 18:
        strcpy(Str3, "surveyor");

        break;
    case 19:
        strcpy(Str3, "jongleur");
