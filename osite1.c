        ...
        while(!done) {
            ...
            if(response == '?') {
                ...
                if(!valid) {
                    ...
                    menuprint("The polic are being summoned!\n");
...
void l_armorer()
{
    ...
    if(hour() == 12) {
        ...
        while(!done) {
            clearmsg();
            print1("Julie's: Buy Armor, Weaponds, or Leave [a,w,ESCAPE] ");
            action = mgetc();
...
void l_club()
{
    ...
    if(!gamestatusp(CLUB_MEMBER)) {
        ...
        print2("Shop at the club store or list for rumors [sl] ");
        response = mcigetc();
...
void l_gym()
{
    ...
    case ESCAPE:
        clearmsg();
        print1("Well, it's your body that you're depraving!");
        done = TRUE;
    ...
    while(!done) {
        ...
        case ESCAPE:
            clearmsg();
            print1("Well, it's your body you're depraving!");
            done = TRUE;
    ...
    case 5:
        if((Current_Environment == Current_Dungeon)
           || (Current_Environment == E_CITY)) {
            print1("You hear the whir of some mechanism.");
...
void l_casino()
{
    ...
    if(random_range(10) == 1) {
        ...
        while(!done) {
            ...
            print2("ESCAPE: Leave this green baize hall.");
            response = mcigetc();
...
void l_diner()
{
    print1("The Rampart Diner. All you can eat, 25 Au.");
    print2("Place a order? [yn] ");
...
void l_tavern()
{
    ...
    print1("The Centaur and Nypmh -- J. Riley, prop.");
...
void l_alchemist()
{
    ...
    if(nighttime()) {
        ...
        while(!done) {
            ...
            print3("ESCAPE: Level this place.");
            response = mcigetc();
                ...
                if((i != ABORT) && (Player.possessions[i] != NULL)) {
                    ...
                    if(ynq2() == 'y') {
                        if(Player.cash < max(10, obj->basevalue * 2)) {
                            ...
                            print1("Voila! A tap of the Philospher's Stone...");
...
void l_dpw()
{
    print1("Rampart Departmnet of Public Works.");
    ...
    if((Date - LastDay) < 7) {
        ...
        if(ynq2() == 'y') {
            ...
            if(strcmp(Player.name, msgscanstring()) != 0) {
                print3("Aha! Welfare Fraud! It's off to the gaol for you, lout!");
                morewait();
                send_to_jail();
            }
            else {
            ...
            if(action == ESCAPE) {
                ...
                if((i != ABORT) && (Player.possessions[i] != NULL)) {
                    if(cursed(Player.possessions[i])) {
                        print1("No loans on cursed items! I have been burned before...");
                    }
                    else {
                        print1("You can get ");
