...
#define FOOD(name, prob, delay, weight, nutrition) \
    ...
    /* %% weight of long worm should be proportional to its length */
...
#define WEAPON(name, prob, wt, ldam, sdam) \
    ...
    {"enormous rock", NULL, NULL, 1, 0, ROCK_SYM, 100, 0, 200 /* > MAX_CARR_CAP */, 0, 0, 0},
...
#define SCROLL(name, text, prob) \
    ...
    SCROLL("destroy armor", "JUYD AWK YACC", 5),
...
#define RING(name, stone, spec) \
    ...
    RING("regeneration", "black oynx", 0),
