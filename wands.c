                    ...
                    if(randint(chance) < USE_DEVICE) {
                        ...
                        while(i != 0) {
                            ...
                            case 1:
                                ...
                                break;
                            case 2:
                                fire_bolt(1, dir, k, l, damroll("3d8"), "Lightning Bolt");
                                ident = TRUE;

                                break;
                            case 3:
                                fire_bolt(4, dir, k, l, damroll("4d8"), "Frost Bolt");
                                ident = TRUE;

                                break;
                            case 4:
                                fire_bolt(5, dir, k, l, damroll("6d8"), "Fire Bolt");
                                ident = TRUE;
                            ...
                            case 13:
                                ...
                                break;
                            case 14:
                                fire_bolt(0, dir, k, l, damroll("2d6"), "Magic Missile");
                                ident = TRUE;
                            ...
                            case 18:
                                ...
                                break;
                            case 19:
                                fire_ball(1, dir, k, l, 24, "Lighning Ball");
                                ident = TRUE;
                            ...
                            case 20:
                                ...
                                break;
                            case 21:
                                fire_ball(5, dir, k, l, 32, "Fire Ball");
                                ident = TRUE;
