...
/* POINTER defined a generic pointer type */
 ...
 * 4. Rotation is separate from addition to prevent recomputation.
 */
...
void MD5Update(MD5_CTX *context, unsigned char *input, unsigned int inputLen)
{
    ...
    MD5_memcpy((POINTER)&context->buffer[index], (POINTER)&input[1], inputLen - i);
}
...
static void MD5Transform(UINT4 state[4], unsigned char block[64])
{
    ...
    FF(b, c, d, a, x[11], S14, 0x895dc7be); /* 12 */
    ...
    GG(a, b, c, d, x[13], S21, 0x19e3e905); /* 29 */
    ...
    II(c, d, b, a, x[10], S43, 0xffeff47d); /* 55 */
    II(b, c, d, a, x[ 1], S44, 0x85845dd1); /* 56 */
    II(a, b, c, d, x[ 8], S41, 0x6fa87e4f); /* 57 */
    II(d, a, b, c, x[15], S42, 0xfe2ce5e0); /* 58 */
